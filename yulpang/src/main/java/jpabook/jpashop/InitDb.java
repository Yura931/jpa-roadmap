...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            Member member = createMember("userA", "부산", "1111", "12341");
            em.persist(member);
        ...
        public void dbInit2() {
            Member member = createMember("userB", "서울", "115", "1111");
            em.persist(member);
        ...
        private static Member createMember(String userB, String city, String street, String zipcode) {
